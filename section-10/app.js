...
// [`kuba`, 'bartosz', 'igor'].forEach(high5);
...
// lufthansa.book(323, `Kuba Wrobel`);
...
// const swiss = {
//   airlane: `Swiss Air Lines`,
//   iataCode: 'LX',
//   booking: [],
// };
// book.call(swiss, 234, `Michał`);

// //apply methot
// const flightData = [584, `grzgorz floryda`];
...
//             `)
//     );
//     if (index >= 0 && index < this.options.length && !isNaN(index)) {
//       this.answers[index]++;
...
// f();
// //example 2
// // : closure example with private variables and methods using IIFEs, closures in JavaScript are created
...
//   }, wait * 1000);
//   console.log(`Will star boarding in ${wait} second`);
// };
// const perGroup = 1000;
